...
namespace Items.Trackable.Observers
{
    ...
    public class MetallicDetector : DetectorAbstract<MetallicTrackable>
    {
        ...
        public override void OnAdd(IObservableBehaviour<MetallicTrackable> observable)
        {
            _metallicTrackable.Add(observable.gameObject.transform);
        }

        public override void OnRemove(IObservableBehaviour<MetallicTrackable> observable)
        {
            _metallicTrackable.Remove(observable.gameObject.transform);
        }

        public override void OnUpdate(MetallicTrackable message)
        {
